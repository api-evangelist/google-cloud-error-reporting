...
- [OpenAPI](openapi/openapi.yml) - The OpenAPI specification for the Error Reporting API.
- [JSON Schema](json-schema/json-schema.yml) - The JSON Schema for Error Reporting resources.
- [JSON-LD Context](json-ld/json-ld.yml) - The JSON-LD context mapping for Error Reporting resources.
